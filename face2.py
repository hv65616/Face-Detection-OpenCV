...
# *****************The following part is for capturing frames and storing it in directory defined******************************
...
# ******************************************************************************************************************************
        ...
        smiles = smile_classifier.detectMultiScale(roi_gray, scaleFactor=1.1, minNeighbors=10, minSize=(15, 15))

        for (sx, sy, sw, sh) in smiles:
            cv2.rectangle(roi_color, (sx, sy), (sx+sw, sy+sh), (255, 0, 0), 2)

        # Here we are taking out part for our eye
        eyes = eye_classifier.detectMultiScale(roi_gray, scaleFactor=1.1, minNeighbors=10, minSize=(15, 15))
